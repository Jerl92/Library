...
class Library {
	...
	private function load_dependencies() {
		 ...
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-library-i18n.php';
		
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-library-cpt.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-library-function.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-library-ajax.php';
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/class-library-admin-metabox.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-library-public.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/partials/library-public-scan.php';
