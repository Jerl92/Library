 ...
 * This action is documented in includes/class-library-activator.php
 */
function activate_library() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-library-activator.php';
	Library_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-library-deactivator.php
 */
function deactivate_library() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-library-deactivator.php';
	Library_Deactivator::deactivate();
}
